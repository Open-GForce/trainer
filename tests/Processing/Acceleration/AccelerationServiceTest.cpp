...
TEST_CASE( "AccelerationService currentSpeed mode tests", "[Processing Acceleration]" )
{
    auto service = new AccelerationService();
    service->setAccelerationMode(AccelerationMode::currentSpeed);
    ...
    SECTION("Minimal speed")
    {
        ...
        int result = service->getAcceleration(11, 50);
        CHECK(result == 2000);
    }
    ...
    SECTION("Maximum speed")
    {
        ...
        int result = service->getAcceleration(21, 50);
        CHECK(result == 3000);
    }
    ...
    SECTION("Intermediate speed")
    {
        ...
        int result = service->getAcceleration(23, 50);
        CHECK(result == 3500);
    }
